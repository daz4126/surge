...
This will mean that the in inner HTML of the `h1` element starts with a value of `0`. It also means that whenever the value of the count changes, the inner HTML will automatically update and re-render.
